  ...
  return (
    <div className="no-underline relative w-[1076px] -left-[calc((1076px-100%)/2)] flex flex-row gap-48">
      ...
      <div className="flex flex-1 relative group">
        <Image
          className="stamp grayscale opacity-30 group-hover:grayscale-0 group-hover:opacity-100 absolute z-10 -top-10 -left-10 -rotate-3 group-hover:scale-105 transition-all ease-in-out duration-300"
        ...
        <Image
          className="stamp grayscale opacity-30 group-hover:grayscale-0 group-hover:opacity-100 absolute z-10 -bottom-8 right-10 -rotate-3 group-hover:scale-105 transition-all ease-in-out duration-300"
